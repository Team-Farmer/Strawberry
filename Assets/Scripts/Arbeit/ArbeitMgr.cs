...
{   
    ...
    void Rachel()//토끼 0
    {
        for (int i = 0; i < GameManager.instance.farmList.Count; i++)
        {
                ...
                DataController.instance.gameData.PTJNum[0] > 0)
            {
                ...
                DataController.instance.gameData.PTJIsWorking[0] = true;//허윤지
    ...
    IEnumerator HarvestbyThomson(int idx)
    {
        ...
        DataController.instance.gameData.PTJIsWorking[1] = true;//허윤지
    ...
    {
        yield return new WaitForSeconds(0.75f);
        DataController.instance.gameData.PTJIsWorking[3] = true;//허윤지
        Farm farm = obj.GetComponent<Farm>();
        farm.weed.DeleteWeed();
        //obj.GetComponent<BoxCollider2D>().enabled = false;
    }
    public float Pigma() // 돼지 5
    {
        if (DataController.instance.gameData.PTJNum[5] > 0)
        {
            ...
            DataController.instance.gameData.PTJIsWorking[5] = true;//허윤지
